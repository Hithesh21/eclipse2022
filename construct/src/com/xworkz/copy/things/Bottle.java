...
public class Bottle {
	...
	public boolean withBag;
	public String[] color;
	public String[] size;
	public String[] shape;
	public String[] materials;
	public int[] price;
	public Bottle(String brand, String type, double height, double weight, boolean withBag, String[] color,
			String[] size, String[] shape, String[] materials, int[] price) {
